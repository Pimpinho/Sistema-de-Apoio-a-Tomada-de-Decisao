...
csv_final_candidato = "csv_final_candidato.csv"
...
# Atualizar csv_final_candidato
df_final = pd.read_csv(csv_final_candidato)
...
# Salvar csv_final_candidato atualizado
df_final.to_csv(csv_final_candidato, index=False)

print(f"Candidato '{nomeCandidato}' adicionado ao csv_final_candidato com quebra de linha.")